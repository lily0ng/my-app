...
export function LoginPage() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Your runs, logs, and usage live in one consistent interface.",
    },
    {
      icon: BadgeCheck,
      title: "Trusted sessions",
      description:
        "Secure sessions and modern auth patterns that keep you protected.",
    },
  ];
  ...
  const helpCards = [
    ...
    },
    {
      ...
      title: "Need help?",
      description:
        "Reach out to support for account access or billing questions.",
      href: "/contact",
    },
    {
      icon: Lock,
                  ...
                  >
                    <div>
                      ...
                      {attemptedSubmit && !emailValid && (
                        <div className="text-xs mt-1 text-[color:var(--text-tertiary)]">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            >
              ...
              <div className="mt-8 space-y-3">
                {[
                  ...
                  "Enable unique passwords per service",
                  "Review access if you share a computer",
                ].map((t) => (
            ...
            >
              ...
              <div className="text-2xl font-bold mt-2">
                One login. Many workflows.
              </div>
              <div className="text-[color:var(--text-secondary)] mt-3">
                Keep a single workspace and invite teammates with appropriate
                permissions.
              </div>
              <div className="mt-6">
                <Link
