...
export function EventsPage() {
  ...
  const [readNewsSlugs, setReadNewsSlugs] = useState<string[]>(() =>
    getReadNewsSlugs(),
  );
  ...
  const selectedGallery =
    galleryCards.find((c) => c.id === selectedGalleryId) ?? galleryCards[0];
  ...
  useEffect(() => {
    ...
    const id = window.setInterval(() => {
      setSelectedGalleryId((prev) => {
        ...
        const next =
          galleryCards[(idx + 1 + galleryCards.length) % galleryCards.length];
  ...
  return (
    <div className="relative min-h-screen w-full bg-[color:var(--bg-primary)] text-[color:var(--text-primary)] overflow-hidden selection:bg-[rgba(var(--accent-rgb),0.30)] selection:text-[color:var(--bg-primary)]">
      <Nav />
        ...
        <section className="pt-40 pb-20 px-6 relative">
          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mt-8">
              <div>
                <h1 className="text-6xl md:text-7xl font-bold leading-[1.0] mb-6">
                  Event &amp; News
                </h1>
                <p className="text-xl text-[color:var(--text-secondary)] max-w-xl leading-relaxed">
                  Upcoming events, meetups, and the latest product news —
                  curated for teams shipping in real time.
                </p>
              ...
              <div className="bg-[color:var(--bg-secondary)] border border-[color:var(--border-color)] rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="text-2xl font-bold mb-2">
                    Realtime Infra Summit
                  </div>
                  <div className="text-[color:var(--text-secondary)] mb-6">
                    Mar 12, 2026 • San Francisco
                  </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
              <div>
                ...
                <p className="text-[color:var(--text-secondary)] max-w-2xl">
                  Product updates, community announcements, and what we’re
                  shipping next.
                </p>
              </div>
              <Link
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
              <div>
                ...
                <p className="text-[color:var(--text-secondary)] max-w-2xl">
                  A curated set of sessions designed to connect builders and
                  teams.
                </p>
              </div>
              <div className="flex items-center gap-3">
              ...
              {featuredEvents.map((ev, i) => (
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="text-xs font-bold tracking-wider text-[color:var(--accent)] mb-3">
                          {ev.track.toUpperCase()}
                        </div>
                        <div className="text-2xl font-bold mb-2">
                          {ev.title}
                        </div>
            ...
            <div className="flex items-end justify-between gap-6 mb-10">
              <div>
                ...
                <p className="text-[color:var(--text-secondary)]">
                  A fast list view for planning your month.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcomingList.map((row, i) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-16 rounded-xl bg-[color:var(--bg-primary)] border border-[color:var(--border-color)] flex flex-col items-center justify-center">
                        <div className="text-xs text-[color:var(--text-secondary)]">
                          {row.day}
                        </div>
                        <div className="font-bold text-center">{row.date}</div>
                      </div>
                      <div>
                        <div className="text-xs font-semibold text-[color:var(--text-tertiary)]">
                          {row.time}
                  ...
                  <div className="mt-5 font-bold text-lg leading-snug">
                    {row.title}
                  </div>
              ...
              <div className="p-10 rounded-2xl bg-[color:var(--bg-secondary)] border border-[color:var(--border-color)] relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-[color:var(--text-secondary)] text-lg leading-relaxed mb-8">
                    Get new events, speaker drops, and product announcements in
                    one clean email.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    />
                    <button
                      className="px-8 py-3 rounded-full bg-[color:var(--accent)] font-bold hover:opacity-95 transition-colors"
                      style={{ color: "white" }}
                    >
                      Subscribe
                    </button>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between gap-6 mb-10">
              <div>
                ...
                <p className="text-[color:var(--text-secondary)]">
                  A live look at recent sessions and community moments.
                </p>
              </div>
                ...
                <div className="p-7 border-b border-[color:var(--border-color)] flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        setSelectedGalleryId((prev) => {
                          const idx = galleryCards.findIndex(
                            (c) => c.id === prev,
                          );
                          const next =
                            galleryCards[
                              (idx - 1 + galleryCards.length) %
                                galleryCards.length
                            ];
                          return next?.id ?? galleryCards[0].id;
                        });
                    ...
                    >
                      <ArrowRight
                        size={18}
                        className="text-[color:var(--text-secondary)] rotate-180"
                      />
                    </button>
                    <button
                      type="button"
              ...
              <div className="rounded-3xl border border-[color:var(--border-color)] bg-[color:var(--bg-secondary)] overflow-hidden">
                <div className="p-7 border-b border-[color:var(--border-color)]">
                  ...
                  <div className="text-sm text-[color:var(--text-secondary)] mt-2">
                    Select a card to update the preview.
                  </div>
                </div>
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="text-sm text-[color:var(--text-secondary)] mt-1 truncate">
                                {c.meta}
                              </div>
                            </div>
                          </div>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-3">
                          <Link
                            to="/contact"
                            className="px-7 py-3 rounded-full bg-[color:var(--accent)] font-bold hover:opacity-95 transition-colors inline-flex items-center justify-center gap-2" style={{color: 'white'}}
                          >
                ...
                <div className="relative w-full max-w-2xl rounded-3xl border border-[color:var(--border-color)] bg-[color:var(--bg-secondary)] overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 p-6 rounded-2xl bg-[color:var(--bg-primary)] border border-[color:var(--border-color)] text-[color:var(--text-secondary)] leading-relaxed">
                      Join the session for talks, demos, and community Q&A.
                      You’ll get the agenda and calendar invite after RSVP.
                    </div>
            ...
            <div className="mt-10 rounded-2xl border border-[color:var(--border-color)] bg-[color:var(--bg-secondary)] overflow-hidden p-10">
              ...
              <p className="text-[color:var(--text-secondary)] leading-relaxed mb-8">
                We support local chapters, partner demos, and hands-on
                workshops. Pitch a topic and we’ll help amplify it.
              </p>
