        ...
        <section className="pt-32 pb-20 px-6 relative">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl md:text-2xl text-[var(--text-secondary)] max-w-3xl mx-auto mb-12 font-light leading-relaxed">
              ...
              applications with our fully managed Kubernetes service.
            </p>
            <div className="flex justify-center gap-6">
              <button
                className="px-10 py-5 rounded-full bg-[var(--accent)] font-bold text-xl hover:bg-[var(--accent-hover)] transition-all hover:scale-105 shadow-[0_18px_60px_rgba(0,0,0,0.10)] dark:shadow-[0_18px_60px_rgba(0,0,0,0.45)]"
                style={{ color: "white" }}
              >
                Create Cluster
              </button>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="mt-4 text-lg text-[var(--text-secondary)] max-w-3xl mx-auto">
                A control plane manages cluster state and schedules workloads
                onto nodes that run the data plane.
              </p>
            </motion.div>
              ...
              <div className="relative rounded-3xl bg-[rgba(255,255,255,0.78)] dark:bg-[rgba(255,255,255,0.03)] ring-1 ring-black/5 dark:ring-white/10 p-6 md:p-8 overflow-hidden">
                ...
                <div className="flex items-center gap-3 text-left">
                  <div className="relative w-9 h-9 rounded-lg bg-[rgba(var(--accent-rgb),0.12)] ring-1 ring-[rgba(var(--accent-rgb),0.22)] flex items-center justify-center">
                    <Network
                      size={18}
                      className="text-[rgba(var(--accent-rgb),0.95)]"
                    />
                  </div>
                  ...
                  >
                    <defs>
                      <linearGradient id="kubeBlue" x1="0" y1="0" x2="0" y2="1">
                        <stop
                          offset="0"
                          stopColor="rgba(var(--accent-rgb),0.55)"
                        />
                        <stop
                          offset="1"
                          stopColor="rgba(var(--accent-rgb),0.28)"
                        />
                      </linearGradient>
                    ...
                    {[
                      ...
                      <g key={b.label}>
                        <rect
                          ...
                          rx="12"
                          fill="url(#kubeCyan)"
                          stroke="rgba(var(--accent-rgb),0.20)"
                          strokeWidth="2"
                        />
                        <text
                          x={b.x + 60}
                    ...
                    {[
                      ...
                      {
                        d: "M 500 250 C 500 275, 500 295, 500 310",
                        delay: 0.15,
                      },
                      {
                        d: "M 500 250 C 580 270, 700 295, 775 310",
                        delay: 0.3,
                      },
                    ].map((p) => (
                      <g key={p.d}>
                        ...
                        <path
                          ...
                          markerEnd="url(#kubeArrow)"
                          style={{
                            animation: "kubeDash 3.4s linear infinite",
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="space-y-6">
                <li className="flex items-center gap-4 text-[var(--text-secondary)] text-lg">
                  <CheckCircle className="text-[var(--accent)]" /> Automatic
                  node discovery
                </li>
                <li className="flex items-center gap-4 text-[var(--text-secondary)] text-lg">
                  <CheckCircle className="text-[var(--accent)]" /> Fast
                  interconnect between nodes
                </li>
                <li className="flex items-center gap-4 text-[var(--text-secondary)] text-lg">
                  <CheckCircle className="text-[var(--accent)]" /> Stream logs
                  from all workers to your terminal
                </li>
              </ul>
            </div>
            <div className="bg-black/5 dark:bg-white/5 ring-1 ring-black/5 dark:ring-white/10 rounded-2xl p-8 font-mono text-sm shadow-[0_18px_60px_rgba(0,0,0,0.10)] dark:shadow-[0_18px_60px_rgba(0,0,0,0.45)]">
              <pre className="text-[var(--text-secondary)]">
                <code>
                  <span className="text-[var(--accent)]">@app.function</span>
                  (gpu=
                  ...
                  <span className="text-[rgba(var(--accent-rgb),0.95)]">
                    deploy
                  </span>
                  ():{"\n"}
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-[var(--text-secondary)]">
                  <CheckCircle className="text-[var(--accent)]" /> High
                  throughput
                </li>
                <li className="flex items-center gap-3 text-[var(--text-secondary)]">
                  <CheckCircle className="text-[var(--accent)]" /> Concurrent
                  access
                </li>
                <li className="flex items-center gap-3 text-[var(--text-secondary)]">
                  <CheckCircle className="text-[var(--accent)]" /> Durable
                  persistence
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="p-10 bg-[rgba(255,255,255,0.70)] dark:bg-[rgba(255,255,255,0.04)] rounded-2xl ring-1 ring-black/5 dark:ring-white/10">
                <div className="text-[var(--accent)] font-bold mb-4">
                  SCALE AI
                </div>
              ...
              <div className="p-10 bg-[rgba(255,255,255,0.70)] dark:bg-[rgba(255,255,255,0.04)] rounded-2xl ring-1 ring-black/5 dark:ring-white/10">
                ...
                <p className="text-[var(--text-secondary)] mb-8">
                  "We deploy new services daily and rely on a managed control
                  plane to keep clusters stable."
                </p>
                <a
                  href="#"
                  className="text-[var(--accent)] font-bold hover:underline"
        ...
        <section className="py-40 px-6 text-center border-t border-[color:var(--border-color)] bg-[radial-gradient(circle_at_top,rgba(var(--accent-rgb),0.18),transparent_55%)]">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-5xl font-bold mb-8">
              Ship faster with Kubernetes
            </h2>
            <p className="text-2xl text-[var(--text-secondary)] mb-12 font-light">
              Create a cluster in minutes and scale with confidence.
            </p>
            <button
              className="px-10 py-5 rounded-full bg-[var(--accent)] font-bold text-xl hover:bg-[var(--accent-hover)] transition-all hover:scale-105 shadow-[0_18px_60px_rgba(0,0,0,0.12)] dark:shadow-[0_18px_60px_rgba(0,0,0,0.55)]"
              style={{ color: "white" }}
            >
