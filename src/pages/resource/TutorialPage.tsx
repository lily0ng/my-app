...
const TutorialPage = () => {
  ...
  const featuredVideos = [
    {
      ...
      duration: "5:23",
      description:
        "Learn the basics of our platform in this comprehensive introduction",
    ...
    },
    {
      ...
      duration: "8:45",
      description:
        "Deploy your first application and understand the deployment process",
      thumbnail: "https://img.youtube.com/vi/mkJ_Ce5-fCY/maxresdefault.jpg",
      videoUrl: "https://www.youtube.com/watch?v=mkJ_Ce5-fCY",
      embedId: "mkJ_Ce5-fCY",
    ...
    },
    {
      ...
      duration: "6:12",
      description:
        "Learn how to create and manage volume snapshots and automated backups",
      thumbnail: "https://img.youtube.com/vi/mkJ_Ce5-fCY/maxresdefault.jpg",
      videoUrl: "https://www.youtube.com/watch?v=mkJ_Ce5-fCY",
      embedId: "mkJ_Ce5-fCY",
      category: "intermediate",
    ...
    },
    {
      ...
      duration: "7:30",
      description:
        "Configure affinity groups for optimal resource placement and performance",
      thumbnail: "https://img.youtube.com/vi/mkJ_Ce5-fCY/maxresdefault.jpg",
      videoUrl: "https://www.youtube.com/watch?v=mkJ_Ce5-fCY",
      embedId: "mkJ_Ce5-fCY",
      category: "advanced",
    ...
    },
    {
      ...
      duration: "9:15",
      description:
        "Set up auto scaling groups to handle varying workloads automatically",
      thumbnail: "https://img.youtube.com/vi/mkJ_Ce5-fCY/maxresdefault.jpg",
      videoUrl: "https://www.youtube.com/watch?v=mkJ_Ce5-fCY",
      embedId: "mkJ_Ce5-fCY",
      category: "advanced",
    ...
    },
    {
      ...
      duration: "10:42",
      description:
        "Configure and deploy load balancers for high availability applications",
      thumbnail: "https://img.youtube.com/vi/mkJ_Ce5-fCY/maxresdefault.jpg",
      videoUrl: "https://www.youtube.com/watch?v=mkJ_Ce5-fCY",
      embedId: "mkJ_Ce5-fCY",
      category: "advanced",
  ...
  const allTags = Array.from(
    new Set(featuredVideos.flatMap((video) => video.tags)),
  );

  const filteredVideos = featuredVideos.filter((video) => {
    const tagsMatch =
      selectedTags.length === 0 || video.tags.includes(selectedTags[0]);
    return tagsMatch;
  });
          ...
          <div className="max-w-7xl mx-auto">
            <section className="pt-40 pb-20 px-6 text-center">
              <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-8">
                Free{" "}
                <span className="text-[color:var(--accent)]">Tutorials</span>
              </h1>
              <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
                From beginner basics to advanced techniques, our video tutorials
                provide comprehensive learning. Master our platform step-by-step
                      ...
                      <div className="">
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                          {video.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-xs bg-white/10 px-2 py-0.5 rounded-xl"
                            >
                              {tag}
                            </span>
                          ))}
        ...
        <section className="py-40 px-6 text-center border-t border-white/5 bg-gradient-to-b from-black to-[#05150d]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-bold mb-8">
              Ready to{" "}
              <span className="text-[color:var(--accent)]">Start?</span>
            </h2>
            <p className="text-2xl text-gray-400 mb-12 font-light">
              Start learning with our first set of video tutorials and build
              your skills step by step as more content is added.
            </p>

            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <button
                className="px-10 py-5 rounded-full bg-[color:var(--accent)] font-bold text-xl hover:bg-[color:var(--accent-hover)] transition-all hover:scale-105 shadow-[0_0_40px_rgba(var(--accent-rgb),0.4)]"
                style={{ color: "white" }}
              >
                Sign Up Now
              </button>
