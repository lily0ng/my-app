    ...
    () => [
      {
        ...
        desc: "Run structure prediction at scale with GPU scheduling.",
      },
      {
        title: "Docking screens",
        desc: "Parallelize large compound libraries across workers.",
      },
      {
        title: "Genomics pipelines",
        desc: "Alignment, variant calling, and QC in batches.",
      },
      {
        title: "Single-cell analysis",
        desc: "Process sparse matrices, embeddings, and clustering.",
      },
      {
        title: "Molecular dynamics",
        desc: "Long simulations with checkpointing and restarts.",
      },
      {
        title: "Cryo-EM",
        desc: "Acceleration for reconstruction and denoising workloads.",
      },
      {
        title: "Lab automation",
        desc: "Ingest instrument outputs and trigger downstream compute.",
      },
      {
        title: "Bio foundation models",
        desc: "Embed sequences and predict properties.",
      },
      {
        title: "Clinical ETL",
        desc: "De-identify and transform datasets securely.",
      },
      {
        title: "Reproducible science",
        desc: "Pin environments and rerun experiments reliably.",
      },
    ],
    [],
  );
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
                ...
                >
                  ...
                  <p className="mt-5 text-base md:text-lg text-[color:var(--text-secondary)] leading-relaxed max-w-xl">
                    Run reproducible pipelines across CPUs and GPUs for drug
                    discovery, genomics, and foundation models.
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <p className="mt-4 text-[color:var(--text-secondary)] leading-relaxed">
                  Keep your preferred frameworks while simplifying orchestration
                  and scaling.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-[color:var(--text-secondary)]">
                Checkpoint long jobs and keep audits for every artifact.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                {
                  t: "Checkpointing",
                  d: "Resume expensive jobs without starting over.",
                  I: Server,
                },
                {
                  t: "Provenance",
                  d: "Track inputs, configs, and outputs automatically.",
                  I: Shield,
                },
                {
                  t: "Parallelism",
                  d: "Scale out across samples, shards, or compounds.",
                  I: Cpu,
                },
              ].map((x) => (
                <motion.div
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-14 rounded-3xl border border-[color:var(--border-color)] bg-[color:var(--bg-secondary)] p-8 text-center">
              ...
              <div className="mt-4 text-2xl font-bold">
                Scale your next experiment
              </div>
              <div className="mt-2 text-[color:var(--text-secondary)]">
                Start from templates and keep everything reproducible.
              </div>
