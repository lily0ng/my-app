    ...
    () => [
      {
        ...
        desc: "Generate variants and pick winners via A/B testing.",
      },
      {
        title: "Product shots",
        desc: "Consistent backgrounds and lighting at scale.",
      },
      {
        title: "Game assets",
        desc: "Textures, sprites, and concept art pipelines.",
      },
      {
        title: "E-commerce",
        desc: "Catalog enrichment and personalized visuals.",
      },
      {
        title: "Video keyframes",
        desc: "Storyboard and keyframe generation for editors.",
      },
      {
        title: "Style transfer",
        desc: "Brand-safe presets and LoRA adapters.",
      },
      { title: "Inpainting", desc: "Fix details with masks and control nets." },
      { title: "Upscaling", desc: "Sharper outputs with SR models." },
      {
        title: "Batch generation",
        desc: "Queue massive runs with retries and checkpoints.",
      },
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
                ...
                >
                  ...
                  <p className="mt-5 text-base md:text-lg text-[color:var(--text-secondary)] leading-relaxed max-w-xl">
                    Build brand-safe image pipelines with batching, caching, and
                    autoscaling—then ship to production.
                  </p>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div className="mt-2 text-sm text-[color:var(--text-secondary)]">
                          Run consistent generation with masks, adapters, and
                          upscalers.
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <p className="mt-4 text-[color:var(--text-secondary)] leading-relaxed">
                  Mix and match models and post-processing while keeping outputs
                  deterministic.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-[color:var(--text-secondary)]">
                Batching, caching, and autoscaling for predictable cost.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                {
                  t: "Batching",
                  d: "Group prompts to keep GPUs utilized.",
                  I: Layers,
                },
                {
                  t: "Caching",
                  d: "Reuse hot inputs and artifacts.",
                  I: Server,
                },
                {
                  t: "Autoscale",
                  d: "Scale up on queue time, down to zero when idle.",
                  I: Zap,
                },
              ].map((x) => (
                <motion.div
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-14 rounded-3xl border border-[color:var(--border-color)] bg-[color:var(--bg-secondary)] p-8 text-center">
              ...
              <div className="mt-4 text-2xl font-bold">
                Build your generation stack
              </div>
              <div className="mt-2 text-[color:var(--text-secondary)]">
                Start from presets, then customize for your brand.
              </div>
